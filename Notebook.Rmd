...
ggplot(data =  year_vs_coun_of_incident_sum_gt_n, aes(y=sum.number, x=reorder(`country of incident`,desc(deathbycoun)) ,fill =year )) +
  geom_col() + 
  # coord_flip() +
   labs(y = "Death total", x = "Country of incident", title = "Death by country of incident \n(Top 20 excluding 'unkown')") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),plot.title = element_text(hjust = 0.5))
```
...
ggplot(data =  year_vs_region_of_origin_sum_gt_n, aes(y=sum.number, x=reorder(`region of origin`, desc(deathbycoun)) ,fill =year )) +
  geom_col() + 
  # coord_flip() +
   labs(y = "Death total", x = "Region of origin", title = "Death by region of origin \n (Top 20 excluding 'unkown')") + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1), plot.title = element_text(hjust = 0.5))
...
Analysis for the path of migration for the deaths caused by drowning or presumed drowning:
